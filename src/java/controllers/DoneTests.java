...
@WebServlet(name = "DoneTests", urlPatterns = {"/done-tests"})
public class DoneTests extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
       
         String url = "/Views/Pages/User/DoneTests.jsp";
        ...
        if (user == null) {
            ...
            try {
                ...
                //get tests
                api_url = APIUtils.getBaseURLAPi() + "test/joined-done?userid=" + user.getId() + "&courseid=" + courseid
