...
@WebServlet(name = "showTestResult_Admin", urlPatterns = {"/show-test-result-admin"})
public class showTestResult_Admin extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
       
        String url = "/Views/Pages/Admin/showTestResult_Admin.jsp";
