...
@WebServlet(name = "TestResultStatistic_Admin", urlPatterns = {"/test-result-statistic-admin"})
public class TestResultStatistic_Admin extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");

        String url = "/Views/Pages/Admin/TestResultStatistic_Admin.jsp";
