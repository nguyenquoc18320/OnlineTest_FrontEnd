...
@WebServlet(name = "ShowResultsOfAuthorTest", urlPatterns = {"/show-result-author-test"})
public class ShowResultsOfAuthorTest extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        String url = "/Views/Pages/User/ResultsOfAuthorTest.jsp";
...
//          try {
                ...
                String url_api = APIUtils.getBaseURLAPi() + "test/results-for-author?testid=" + testid
                        + "&authorid=" + user.getId() + "&page=" + page + "&limit=" + maxPageItems; 
